package com.example.maccawapplication;
...
public class AppleNectar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_apple_nectar);
...
//          Create message
            String message = String.format("%d Apple Nectar ordered! Total is LBP %.3f", quantity, total);
